...
_jquery2.default.fn.swapWith = function (to) {
  return this.each(function () {
    var copy_to = (0, _jquery2.default)(to).clone(true);
    var copy_from = (0, _jquery2.default)(this).clone(true);
    (0, _jquery2.default)(to).replaceWith(copy_from);
    (0, _jquery2.default)(this).replaceWith(copy_to);
  });
};
...
(0, _jquery2.default)('document').ready(function () {
  ...
  // });
  (0, _jquery2.default)('.slider').each(function (sliderNum, slider) {
    (0, _jquery2.default)('.slider__item', slider).each(function (itemNum, item) {
      var itemNumS = itemNum;

      swipedetect(item, function (swipedir) {

        if (swipedir === 'right') {
          if ((0, _jquery2.default)(item).prev().length) {
            (0, _jquery2.default)(item).prev().removeClass('slider__item--left').addClass('slider__item--right');

            (0, _jquery2.default)(item).removeClass('slider__item--active');
            (0, _jquery2.default)(item).prev().addClass('slider__item--active');
          }
        } else if (swipedir === 'left') {
          if ((0, _jquery2.default)(item).next().length) {
            (0, _jquery2.default)(item).removeClass('slider__item--right').addClass('slider__item--left');
            (0, _jquery2.default)(item).removeClass('slider__item--active');
            (0, _jquery2.default)(item).next().addClass('slider__item--active');
          }
        }
      });
      (0, _jquery2.default)(item).click(function (e) {
        (0, _jquery2.default)('.slider__item', slider).removeClass('slider__item--active');
        (0, _jquery2.default)(item).addClass('slider__item--active');

        if (!itemNum) itemNum = 0;
        var $rightItems = (0, _jquery2.default)('.slider__item:nth-child(n + ' + itemNum + ')', slider);
        var $leftItems = (0, _jquery2.default)('.slider__item:nth-child(-n + ' + itemNum + ')', slider);
  ...
  (0, _jquery2.default)('.slider').find('.slider__caret--left').click(function (e) {
    e.stopPropagation();
    var curitem = (0, _jquery2.default)(e.target).siblings().find('.slider__item--active')[0];
    var curdot = (0, _jquery2.default)(e.target).siblings().find('.button-controls.active')[0];
    console.log(e.target);
    if ((0, _jquery2.default)(curitem).prev().length) {
      (0, _jquery2.default)(curdot).removeClass('active');
      (0, _jquery2.default)(curdot).prev().addClass('active');
      (0, _jquery2.default)(curitem).removeClass('slider__item--left').addClass('slider__item--right');
      (0, _jquery2.default)(curitem).removeClass('slider__item--active').removeClass('slider__item--active');
      (0, _jquery2.default)(curitem).prev().removeClass('slider__item--left').addClass('slider__item--active');
    }
  });
  (0, _jquery2.default)('.slider').find('.slider__caret--right').click(function (e) {
    e.stopPropagation();
    var curitem = (0, _jquery2.default)(e.target).siblings().find('.slider__item--active')[0];
    var curdot = (0, _jquery2.default)(e.target).siblings().find('.button-controls.active')[0];
    console.log(e.target);
    if ((0, _jquery2.default)(curitem).next().length) {
      (0, _jquery2.default)(curdot).removeClass('active');
      (0, _jquery2.default)(curdot).next().addClass('active');
      (0, _jquery2.default)(curitem).removeClass('slider__item--right').addClass('slider__item--left');
      (0, _jquery2.default)(curitem).removeClass('slider__item--active');
      (0, _jquery2.default)(curitem).next().removeClass('slider__item--right').addClass('slider__item--active');
    }
  });
  ...
  var trigger = (0, _jquery2.default)('#hamburger'),
  ...
  function burgerTime() {
    ...
    if (item.hasClass('section--main')) {
      // правые элементы
      blockleft = (0, _jquery2.default)('.service__caption, .service__description, .service__note-caption, .service__note, .service__buttons', item);
      // левые элементы
...
var _controlled_input = __webpack_require__(23);

var _controlled_input_discret = __webpack_require__(24);

var _certs_nominal_select = __webpack_require__(25);
...
var CertApp = exports.CertApp = function (_React$Component) {
    _inherits(CertApp, _React$Component);
    ...
    _createClass(CertApp, [{
        ...
        key: 'certCountChange',
        value: function certCountChange(count) {
        ...
        key: 'dialogue',
        value: function dialogue(context) {
            ...
            swal({
                ...
                var result = {
                    name: (0, _jquery2.default)('#swal-input-name').val(),
                    contact: (0, _jquery2.default)('#swal-input-contact').val()
                };
                ...
                }.bind(context)).catch(function (arg) {
                    swal('Ошибка', 'ошибка сервера - обратитесь к нам по телефону', 'error');
                });
            }, function (dismiss) {}.bind(this)).catch(swal.noop);
        ...
        value: function selectedNominal(selectEvent) {
            var selectedValue = selectEvent.target.value;
            var state = {};
        ...
        value: function render() {
            var total_summ = this.state.count * this.state.nominal;
...
(0, _jquery2.default)('document').ready(function () {
    ...
    if (typeof CertApp != 'undefined' && document.getElementById('cert-app-wed')) _reactDom2.default.render(_react2.default.createElement(CertApp, { nominal: 15000, nominalMode: 15000, certype: WEDDING }), document.getElementById('cert-app-wed'));
});
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(6).setImmediate, __webpack_require__(6).clearImmediate))
...
exports.ControlledCertificateInput = undefined;
...
var ControlledCertificateInput = exports.ControlledCertificateInput = function (_React$Component) {
    _inherits(ControlledCertificateInput, _React$Component);

    function ControlledCertificateInput(props) {
        _classCallCheck(this, ControlledCertificateInput);
    ...
    _createClass(ControlledCertificateInput, [{
        ...
        key: 'santinizeValue',
        value: function santinizeValue(event) {
    ...
    return ControlledCertificateInput;
}(_react2.default.Component);
...
exports.ControlledInput = undefined;
...
var ControlledInput = exports.ControlledInput = function (_React$Component) {
    _inherits(ControlledInput, _React$Component);

    function ControlledInput() {
        _classCallCheck(this, ControlledInput);

        var _this = _possibleConstructorReturn(this, (ControlledInput.__proto__ || Object.getPrototypeOf(ControlledInput)).call(this));
    ...
    _createClass(ControlledInput, [{
        ...
        key: 'changeCountEvent',
        value: function changeCountEvent(event) {
            this.changeCount(event.target.value);
        }
    }, {
        key: 'changeCount',
        value: function changeCount(val) {
            if (val < 1) val = 1;
            if (val > this.config.max_value) val = this.config.max_value;
            var state = Object.assign({}, this.state);
            state.value = val;
...
exports.CertsNominalSelect = undefined;
...
// import $ from 'jquery';
// !!!Stateless component!!!
var CertsNominalSelect = exports.CertsNominalSelect = function (_React$Component) {
    _inherits(CertsNominalSelect, _React$Component);

    function CertsNominalSelect(props) {
        _classCallCheck(this, CertsNominalSelect);
...
(0, _jquery2.default)('document').ready(function () {
  ...
  (0, _jquery2.default)(".main-header__support").click(function (e) {
    e.preventDefault();
    jivo_api.open();
  });
  (0, _jquery2.default)(".service__button-call>a, \
